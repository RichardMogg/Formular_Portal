...
window.FORM_RUNTIME_CONFIG = {
  "exportVersion": "0.1.0",
  "generatedAt": "2026-05-29T23:05:10.846Z",
  "schema": {
    "appType": "form-builder-schema",
    "schemaVersion": "0.3.0",
    "title": "Sörungsbericht",
    "subtitle": "zur Firmen internen Verwendung nur PDF",
    "version": "V1.0",
    "theme": {
      "defaults": {
        "colors": {
    ...
    "footer": {
      ...
      "lines": [
        {
          "text": "GEBATECH GmbH | Gebäude- und Anlagentechnik | T +43 7252 93074 | F -400 "
        },
        {
          "text": "Im Stadtgut Zone E 20, A-4407 Steyr | office@gebatech.at | www.gebatech.at"
        }
      ]
    },
    "sections": [
      ...
      {
        "id": "section_mprix2qd_fyw86",
        "title": "2. Neuer Abschnitt",
        "subtitle": "Beschreibung des Abschnitts",
        "openByDefault": false,
        "fields": [
          {
            "id": "neues_feld_mprixgna_dcehi",
            "label": "Problemstellung lt. Kunde",
            "type": "text",
            "required": false,
            "unit": "",
            "widthPercent": 100
          ...
          {
            "id": "neues_feld_mprj1b2s_xzy1t",
            "label": "Störungsbehebung:",
            "type": "textarea",
            "required": false,
            "unit": "",
            "widthPercent": 100
    ...
    "assets": {
      ...
      "backgroundGraphic": {
        ...
        "layout": {
          "scalePercent": 129,
          "positionXPercent": 109.1,
          "positionYPercent": 64.6
        }
      }
    },
    "runtime": {

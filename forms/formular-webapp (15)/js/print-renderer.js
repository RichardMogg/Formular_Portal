...
function buildFormPrintCss() {
  return [
    ...
    '.print-background-watermark svg{position:absolute;left:var(--print-bg-x);top:var(--print-bg-y);width:var(--print-bg-scale);height:auto;max-width:none;max-height:none;transform:translate(-50%,-50%)}',
